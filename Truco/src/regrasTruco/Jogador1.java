...
public class Jogador1 {
	...
	public Cartas comprarCarta2() {
		return baralho.cartasDaMao(monte).get(1);
	}

	public Cartas comprarCarta3() {
		return baralho.cartasDaMao(monte).get(2);
	}
	...
	public static void main(String[] args) {
		...
		Cartas carta2 = iniciante.comprarCarta2();
		Cartas carta3 = iniciante.comprarCarta3();
		String jogada;
		...
		System.out.println(carta2.name());
		System.out.println(carta3.name());
